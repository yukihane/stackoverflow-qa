...
a persistence unit "jaso83604PersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/com/github/yukihane/jaso/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "jaso83604/pom.xml":
...
artifact ("jaso83604.war") is already built. You can build
